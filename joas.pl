...
investimentos(fii):-:-conta_poupanca(adequada),renda(adequada).
investimentos(imovel):-:-conta_poupanca(adequada),renda(inadequada).
investimentos(titulo):-conta_poupanca(inadequada),renda(adequada).
